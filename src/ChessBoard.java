...
//Credits: https://stackoverflow.com/questions/18686199/fill-unicode-characters-in-labels/18686753#18686753
/*
...
public class ChessBoard {
    ...
    public static void main(String[] args) {
        ...
        Runnable r = new Runnable() {
            ...
            @Override
            public void run() {
                /* Getting rid of the first dialog box, now program only displays the chessboard.
                int gradient = JOptionPane.showConfirmDialog(
                        null, "Use gradient fille color?");*/
                //original code: boolean gradientFill = gradient == JOptionPane.OK_OPTION;
                ...
                addPiecesToContainer(
                        ...
                        tileSetOrder,
                        gradientFill);
                /* This is the "save the gradient file stuff"
    ...
    //method to return a dictionary or a hashmap that displays a chess piece and their appropriate icon.
}
